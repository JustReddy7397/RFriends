package ga.justreddy.wiki.rfriendscommon.bungee;

import com.google.common.base.Strings;
import com.google.common.collect.Maps;
import ga.justreddy.wiki.rfriendscommon.bungee.base.Dependency;
import ga.justreddy.wiki.rfriendscommon.bungee.util.Urls;
import ga.justreddy.wiki.rfriendscommon.bungee.util.Xmls;
...
public class DLoaderBungee {

    private static DLoaderBungee instance;
    ...
    public void onLoad(Plugin bungeePlugin) {
        if(!working) return;
        dependencyFolder = new File("plugins/" + bungeePlugin.getDataFolder().getName() + "/libs");
    ...
    public static DLoaderBungee getInstance() {
        if(instance == null) instance = new DLoaderBungee();
        return instance;
    }
