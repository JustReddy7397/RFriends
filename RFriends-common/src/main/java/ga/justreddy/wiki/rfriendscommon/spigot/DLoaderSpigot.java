package ga.justreddy.wiki.rfriendscommon.spigot;

import com.google.common.base.Strings;
import com.google.common.collect.Maps;
import ga.justreddy.wiki.rfriendscommon.spigot.base.Dependency;
import ga.justreddy.wiki.rfriendscommon.spigot.util.Urls;
import ga.justreddy.wiki.rfriendscommon.spigot.util.Xmls;
...
public class DLoaderSpigot {

    private static DLoaderSpigot instance;
    ...
    public void onLoad(JavaPlugin javaPlugin){
        if (!working) return;
        dependencyFolder = new File("plugins/"+ javaPlugin.getDataFolder().getName() +"/libs");
    ...
    public static DLoaderSpigot getInstance() {
        if(instance == null) instance = new DLoaderSpigot();
        return instance;
    }
